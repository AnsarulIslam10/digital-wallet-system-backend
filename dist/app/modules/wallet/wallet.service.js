...
const getMyWallet = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const wallet = yield wallet_model_1.Wallet.findOne({ user: userId }).populate('user', 'name email role phone');
    if (!wallet)
        throw new AppError_1.default(404, 'Wallet not found');
    return wallet;
});
const getAllWallets = () => __awaiter(void 0, void 0, void 0, function* () {
    return wallet_model_1.Wallet.find().populate('user', 'email role');
});
